    ...
    !   12/01/2018      P. Bajpai           A conditional read statement was added for IDWZ block to read the total
    !                                        charge on a constituent of aqueous phase. This charge is a dummy
